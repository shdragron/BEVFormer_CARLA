#!/usr/bin/env bash
# Run one detr3d eval pass on a condition-specific val pkl and print the
...
#   * env = legacy-mmdet140-b200 (CAPE/PETR/DETR3D env), root = viewpoint/BEVFormer/detr3d
...
DETR3D_ROOT=/home/hanyan_arch/viewpoint/BEVFormer/detr3d
