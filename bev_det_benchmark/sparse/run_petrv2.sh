#!/usr/bin/env bash
# Run one petrv2 eval pass on a condition-specific val pkl and print the
...
#   * env = legacy-mmdet140-b200 (CAPE/PETR/DETR3D env), root = viewpoint/BEVFormer/PETR
...
PETRV2_ROOT=/home/hanyan_arch/viewpoint/BEVFormer/PETR
